...
def resnet50(pretrained=True, root='/Users/sksingh/Desktop/DASNet-master', **kwargs):  #cahnged path
    ...
    if pretrained:
        model_pth = '/Users/sksingh/Desktop/DASNet-master/resnet50-19c8e357.pth'
        model.load_state_dict(torch.load(model_pth))
        print('load pretrained resnet50:', model_pth)
    return model


def resnet101(pretrained=False, root='/Users/sksingh/Desktop/DASNet-master', **kwargs):
    ...
    if pretrained:
        model_pth = '/Users/sksingh/Desktop/DASNet-master/resnet101-5d3b4d8f.pth'
        model.load_state_dict(torch.load(model_pth))
