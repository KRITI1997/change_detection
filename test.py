...
def validate(net, val_dataloader,save_change_map_dir,save_roc_dir):
    ...
    with torch.no_grad():
        ...
        for batch_idx, batch in enumerate(val_dataloader):
            ...
            inputs1, input2, targets = inputs1.cpu(), input2.cpu(), targets.cpu()
            ...
            #cv2.resize(gt, dsize=(256,256), interpolation=cv2.INTER_CUBIC)
            print(gt[0].shape)
...
def main():
    ...
    #val_data = dates.Dataset('/Users/sksingh/Desktop/DASNet-master/dataset/', '/Users/sksingh/Desktop/DASNet-master/dataset/',
     #                        '/Users/sksingh/Desktop/DASNet-master/dataset/val.txt', 'val', transform=True,
    ...
    print("[INFO] validating dataset contains {} samples...".format(
        len(val_data)))             
    ...
    print('load success')
    model = model.cpu()
    save_change_map_dir ='/Users/sksingh/Desktop/DASNet-master/'
    save_roc_dir = '/Users/sksingh/Desktop/DASNet-master/'
    validate(model,val_loader,'/Users/sksingh/Desktop/DASNet-master/', '/Users/sksingh/Desktop/DASNet-master/')
    time_start = time.time()
    inputs1=cv2.imread('/Users/sksingh/Desktop/DASNet-master/dataset/val/B/val_12.png')
    inputs2=cv2.imread('/Users/sksingh/Desktop/DASNet-master/dataset/val/A/val_12.png')
    print(inputs1.shape)
    resized_input1=cv2.resize(inputs1, dsize=(256,256), interpolation=cv2.INTER_CUBIC)
    print(resized_input1.shape)
    resized_input2=cv2.resize(inputs2, dsize=(256,256), interpolation=cv2.INTER_CUBIC)
    #prediction=net(resized_input1, resized_input2)
    #out_conv5, out_fc, out_embedding = net(resized_input1, resized_input2)
    #model = net(resized_input1,resized_input2)
    #model.load_state_dict(torch.load('/Users/sksingh/Desktop/DASNet-master/CDD_model_best.pth', map_location=torch.device('cpu'))['state_dict'])
    


    #numpy_image=img_to_array(inputs1)
